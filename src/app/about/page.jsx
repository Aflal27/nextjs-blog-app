      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to Aflal&apos;s Blog! Created by Aflal, this blog serves
              as a personal platform to share his insights and ideas with the
              world. Aflal is an enthusiastic developer who enjoys writing about
              technology, coding, and a variety of related topics.
            </p>

            <p>
              On this blog, you&apos;ll discover weekly articles and tutorials
              covering a range of topics including web development, software
              engineering, and programming languages. Aflal is continually
